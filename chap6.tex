...
\begin{figure}[!b]
  \centering
  \includegraphics[width=11cm]{images/selection/vertex_recon/merging_candidates_cos_theta}
...
\begin{figure}[!b]
  \centering
  \includegraphics[width=11cm]{images/selection/vertex_recon/distance_ratio_event_display}
  \caption{Example event display showing how the distance ratio is calculated.  The distance ratio is defined as $d^{\textrm{small}}/d^{\textrm{large}}$.  The blue lines are the two reconstructed tracks which form the merging candidate and the red square is the crossing location of those tracks.}
