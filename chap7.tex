...
\begin{figure}
  ...
  \caption{The number of reconstructed events in the Monte Carlo sample, separated into the prong topologies.  Each event is catagorised by the associated truth information from the simulation.}
...
\caption{Total prong charge vs the number of prong scintillators hits for barrel ECal events in the 1 prong topology.}
...
\caption{Total prong charge vs the number of prong scintillators hits for barrel ECal events in the 2 prong topology.}
...
\caption{Total prong charge vs the number of prong scintillators hits for barrel ECal events in the 3 prong topology.}
...
\caption{$\Delta N$ vs the number of prong scintillators hits for barrel ECal events in the 1 prong topology.}
...
\caption{$\Delta N$ vs the number of prong scintillators hits for barrel ECal events in the 2 prong topology.}
...
\caption{$\Delta N$ vs the number of prong scintillators hits for barrel ECal events in the 3 prong topology.}
...
\begin{figure}%
  \centering
  \subfloat[Barrel ECals.]{\includegraphics[width=9cm]{images/selection/mc_selection/OpeningAngle_2Prong_Barrel.eps} \label{fig:Sel2OpeningAngleBarrel}}
  \subfloat[DS ECals.]{\includegraphics[width=9cm]{images/selection/mc_selection/OpeningAngle_2Prong_DS.eps}\label{fig:Sel2OpeningAngleDS}}
...
\begin{figure}%
  \centering
  \subfloat[Barrel ECals.]{\includegraphics[width=9cm]{images/selection/mc_selection/OpeningAngle_3Prong_Barrel.eps} \label{fig:Sel3OpeningAngleBarrel}}
  \subfloat[DS ECal.]{\includegraphics[width=9cm]{images/selection/mc_selection/OpeningAngle_3Prong_DS.eps}\label{fig:Sel3OpeningAngleDS}}
...
\subsection{Performance of selection}
...
\begin{figure}
  \centering
  \subfloat[Barrel ECals.]{\includegraphics[width=9cm]{images/selection/selection_performance/EffPur_SummedTopologies_Barrel.eps} \label{fig:EffPurSummedTopologiesBarrel}}
  \subfloat[DS ECal.]{\includegraphics[width=9cm]{images/selection/selection_performance/EffPur_SummedTopologies_DS.eps} \label{fig:EffPurSummedTopologiesDS}}
...
\begin{figure}
  \centering
  \subfloat[Barrel ECals.]{\includegraphics[width=9cm]{images/selection/mc_selection/ProngStack_Barrel_Selected.eps} \label{fig:ProngStackBarrelSelected}}
  \subfloat[DS ECal.]{\includegraphics[width=9cm]{images/selection/mc_selection/ProngStack_DS_Selected.eps} \label{fig:ProngStackDSSelected}}
  \caption{The number of selected events in the Monte Carlo sample, separated out into the prong topologies.  Each event is catagorised by the associated truth information from the simulation.}
  \label{fig:ProngStackSelected}
\end{figure}
The number of selected events for each prong topology is shown in Fig.\ref{fig:ProngStackSelected}, with each topology broken down by event catagories.  For both the barrel and DS, signal events dominate each prong topology.  The most impure topology for both detectors is the 1 prong topology.  This is primarily due to having an insufficient number of prongs to really benefit from what the reconstruction can provide.  Despite this, it is clear that the selection results in a pure sample of events.  
\newline
\newline
