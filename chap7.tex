...
\begin{figure}
  ...
  \label{fig:Run3CFlux}
\end{figure}
The POT-scaled integral of this distribution provides the total neutrino flux used in this study.  As the analysis ran over $1.31\times10^{20}$~POT, the integral of Fig.~\ref{fig:Run3CFlux} multiplied by the collected POT gives a total neutrino flux of $1.22\times10^{12}$~cm$^{-2}$.
\newline
\newline
...
\begin{equation}
\langle \sigma^{\textrm{CC}}_{\textrm{Pb}} \rangle_{\phi} = 1.68^{+0.28}_{-0.26} \times 10^{-38} \textrm{ cm}^2 \textrm{ nucleon}^{-1}.
\end{equation}
