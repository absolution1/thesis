...
\begin{table}
  \begin{tabular}{ c c c c c c c }
    Parameter set & FSIQEL & FSIQEH & FSIINEL & FSIABS & FSICXL & FSICXH \\ \hline \hline
  \end{tabular}
  \caption{Summary of the DS ECal components.}
  \label{table:DSECalComponents}
\end{table}
